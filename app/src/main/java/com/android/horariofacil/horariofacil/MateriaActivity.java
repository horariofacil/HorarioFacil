...
public class MateriaActivity extends AppCompatActivity {
    ...
    String codMateria = "";
    Intent intentMateria = getIntent();
    if (intentMateria.hasExtra("codMateria"))
        codMateria = intentMateria.getStringExtra("codMateria");
    else{
        Log.e("Erro Intent", "Materia nao encontrada");
        finish();
    }
